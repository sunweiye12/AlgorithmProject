package C02分类算法.C01队列栈;

/**
 * 题目描述:有一组数，对于其中任意两个数，若前面一个大于后面一个数字，则这两个数字组成一个逆序对。请设计一个高效的算法，
 * 计算给定数组中的逆序对个数。
...
//        merge(arr,mid+1,right);
    ...
    public static int mergerSort(int[] arr,int left,int mid,int right){
        ...
        while (p1 <= mid && p2 <= right){
        	//***重点***两部分分开考虑.由于两部分都是由大到小排序的,当左面的一个数A大于右面的一个数B时
